...
RUN curl -L -o /tmp/nodejs.tar.gz https://nodejs.org/dist/v${NODE_VERSION}/node-v${NODE_VERSION}-linux-x64.tar.gz  && tar xfvz /tmp/nodejs.tar.gz -C /usr/local --strip-components=1  && rm -f /tmp/nodejs.tar.gz
